...
import { innerHotelsPics, requirements } from './Home'
import './zcss.css'
...
export const Hotels=()=>{
    ...
    let {hospital,  airport,  railwayStation, busStand, food}=requirements
        ...
        <div>
            <div className="hotel-main">
                ...
                <div className='hotel-side'>
                    <a href={hospital}   target='_blank' rel="noreferrer">Hospital</a>
                    <a href={airport}   target='_blank'rel="noreferrer">Airport</a>
                    <a href={railwayStation}   target='_blank'rel="noreferrer">RailWay Stations</a>
                    <a href={busStand}   target='_blank'rel="noreferrer">Bus Station</a>
                    <p>{food}</p>
                </div>
            </div>
        </div>
